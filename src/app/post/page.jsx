        ...
        <div className="flex flex-col justify-center items-center gap-1 p-4">
          ...
          <div className="w-full flex flex-col items-start justify-center bg-slate-800/50 backdrop-blur-md rounded-lg px-5 py-3">
            <p className="font-light ">
              ...
              consectetur amet, voluptas, magnam debitis praesentium? Nemo quia
              sunt et veniam eius maxime cum laboriosam velit minima sit, odit
              saepe quos ut consectetur, fugiat dolorum soluta debitis
              ...
              quaerat reiciendis commodi quidem eaque illum explicabo similique
              sequi quas provident iure enim adipisci maiores hic esse magni,
              rerum numquam ipsa consequatur quos inventore. Error fuga aperiam
              cupiditate quas minus libero. Minus deserunt ipsam suscipit unde,
              ad nobis libero debitis deleniti soluta expedita possimus
              veritatis illum officiis sint recusandae? Sint vel itaque beatae
              ipsam reiciendis eos consectetur veritatis ea id possimus quisquam
              sequi, dolorem eius recusandae iste quibusdam accusantium.
            </p>
          </div>
          <div className="w-full flex flex-col items-start justify-center bg-slate-800/50 backdrop-blur-md rounded-lg px-5 py-3">
            tag
